...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		return http.cors().and().csrf(AbstractHttpConfigurer::disable).authorizeHttpRequests(authorize -> authorize
				...
				// Bill permissions
				.requestMatchers("/api/v1/bill/read").hasRole("READ_BILL").requestMatchers("/api/v1/bill/delete")
				.hasRole("DELETE_BILL")
				...
				.logout(logout -> logout.logoutSuccessUrl("http://localhost:5173").deleteCookies("JSESSIONID")
						.permitAll())
	...
	private static final String[] AUTH_WISH_SWAGGER = { "/api/v1/auth/**", "/v3/api-docs/**", "/v3/api-docs.yaml",

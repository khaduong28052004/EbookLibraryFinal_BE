...
@CrossOrigin("*")
@RestController
@RequestMapping("/api/v1/admin/orderstatistacal/account")
public class ApiThongKeKhachHang {
    @Autowired
    Service_ThongKe_KhachHang service_Thongke;
    ...
    public ApiResponse<PageImpl<Response_TK_Account>> getAll(
        ...
        return ApiResponse.<PageImpl<Response_TK_Account>>build()
                .result(service_Thongke.getAll(dateStart, dateEnd, search, gender, page, size, sortBy,
                        sortColumn));
    }
}

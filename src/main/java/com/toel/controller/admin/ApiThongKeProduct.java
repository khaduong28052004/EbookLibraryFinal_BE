...
public class ApiThongKeProduct {
        ...
        @GetMapping
        public ApiResponse<Page_TK_Product> getAllTKDT_Seller(
                ...
                return ApiResponse.<Page_TK_Product>build()
                                .result(service_ThongKe_Product.get_TKDT_Product(dateStart, dateEnd, option, search,

...
public class Service_SellectProductSeller {
	...
	public Map<String, Object> getAllProduct(Account shop, Category category, Integer size, String sort) {
		Map<String, Object> response = new HashMap<>();
		Pageable pageable = PageRequest.of(0, size, Sort.by(sort));
		Page<Product> pageProducts = productRepo.findAllByAccountAndCategoryNot(shop, category, pageable);
